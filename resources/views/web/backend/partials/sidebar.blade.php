...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="" class="app-brand-link">
            {{-- {{ file_exists(public_path('frontend/assets/images/login-img.png')) ? asset('frontend/assets/images/login-img.png') : asset('uploads/default.png') }} --}}
            @if ($setting && $setting->logo)
                <img src="{{ asset($setting->logo) }} " style="height: 95px;width: 176px;" alt="Logo">
            @else
                <img src="{{ asset('frontend/assets/images/login-img.png') }}" style="height: 95px;width: 176px;" alt="Default Logo">
            @endif
        </a>
